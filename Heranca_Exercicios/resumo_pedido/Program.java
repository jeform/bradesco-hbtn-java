...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        produtos.Livro livro3 = new produtos.Livro("Mindset Milionario", 2021, "Brasil", 31.70, 272, "Jose Roberto Marques", 1);

        produtos.Dvd dvd1 = new produtos.Dvd("Anjos da Noite 5 - Guerras de Sangue", 2016, "Estados Unidos", 16.90, "Anna Foerster", "Acao", 91);
        produtos.Dvd dvd2 = new produtos.Dvd("Annabelle 2 - A Criacao do Mal", 2017, "Brasil", 39.90, "James Wan e Peter Safran", "Terror", 109);
